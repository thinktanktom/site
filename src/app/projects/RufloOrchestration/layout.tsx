...
import RufloOrchestrationDocSidebar from '@components/RufloOrchestrationDocSidebar'
import AiDocNotice from '@components/AiDocNotice'

export default function RufloOrchestrationDocLayout({ children }: { children: React.ReactNode }) {
  return (
