...
import { sidebarNav, isSidebarGroup, type SidebarLeaf } from '@lib/ruflo-orchestration-sidebar'

function slugToHref(slug: string[]) {
  return `/projects/RufloOrchestration/${slug.join('/')}`
}
...
function SidebarContent({ onLinkClick }: { onLinkClick?: () => void }) {
  return (
    <nav className="py-6 px-4">
      <Link
        href="/projects/RufloOrchestration"
...
export default function RufloOrchestrationDocSidebar() {
  ...
  return (
    <>
      ...
      <button
        ...
        aria-controls="ruflo-orchestration-mobile-nav"
      >
        <Menu size={18} />
      </button>
      ...
      {mobileOpen && (
        <div
          id="ruflo-orchestration-mobile-nav"
          role="dialog"
          aria-modal="true"
          aria-label="AI Agent Orchestration documentation navigation"
