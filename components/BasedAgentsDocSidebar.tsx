...
import { sidebarNav, isSidebarGroup, type SidebarLeaf } from '@lib/based-agents-sidebar'

function slugToHref(slug: string[]) {
  return `/projects/BasedAgents/${slug.join('/')}`
}
...
export default function BasedAgentsDocSidebar() {
  ...
  return (
    <>
      ...
      <button
        ...
        aria-controls="based-agents-mobile-nav"
      >
        <Menu size={18} />
      </button>
      ...
      {mobileOpen && (
        <div
          id="based-agents-mobile-nav"
          role="dialog"
          aria-modal="true"
          aria-label="Based Agents documentation navigation"
